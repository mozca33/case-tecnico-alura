...
public record TaskMultipleChoiceDTO(
    ...
    public TaskMultipleChoiceDTO {
    }

    public TaskMultipleChoiceDTO withType(Type newType) {
        return new TaskMultipleChoiceDTO(this.id, this.courseId, this.statement, this.order, newType, this.options);
    }
}
